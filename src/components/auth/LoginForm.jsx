        ...
        <div className="w-full flex flex-col py-6 px-4">
            <div className="text-center mb-5 flex-shrink-0">
                ...
                <h2 className="text-2xl font-bold text-blue-700">
                    {userType === 'mentor' ? "Mentor Login" : "Student Login"}
                </h2>
                <p className="text-gray-500 text-sm mt-1">
                    {userType === 'mentor' ? "Access your mentor dashboard" : "Please enter your details to sign in"}
                </p>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-3 flex-shrink-0">
                ...
                {error && (
                    <div className={`px-4 py-2 rounded-lg text-sm border flex flex-col ${error.toLowerCase().includes("verify")
                        ...
                        {(error.toLowerCase().includes("verify")) && (
                            <button
                                ...
                                className="text-blue-600 hover:text-blue-800 text-xs font-semibold mt-1 self-start ml-6 hover:underline"
                            >
                                Click here to get a verification link
                            </button>
                        )}
                    </div>
                )}
                ...
                {success && (
                    <div className="bg-green-50 text-green-600 px-4 py-2 rounded-lg text-sm border border-green-100 flex items-center">
                        <span>{success}</span>
                    </div>
                )}
                ...
                >
                    {isLoading ? "Logging in..." : (userType === 'mentor' ? "Login as Mentor" : "Sign in")}
                </button>
            </form>
