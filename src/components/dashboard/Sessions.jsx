...
import { ChevronLeft, ChevronRight, Search, ChevronDown, ChevronUp, Users, Clock, FileText, Target, Calendar, User, Download, Plus } from 'lucide-react';
...
const Sessions = () => {
  ...
  const sessionNotes = [
    {
      id: 1,
      text: "Andrea posted 3 activities to complete",
      notes: "View Notes"
    },
    {
      id: 2,
  ...
  const upcomingSessions = [
    {
      id: 1,
      title: "Andrea Watson at 3:00 pm",
  ...
  const pastSessions = [
    {
      ...
      sessionNotes: [
        ...
        "Learn as much about your listeners as you can. This will help you determine your choice of words, level of information, organization pattern, and motivational statement."
      ],
      attachments: [
        { name: "More_Public_Speaking_Tips.pdf", icon: "📄" }
      ],
      attendees: [
        { name: "Andrea Watson", task: "Watch Figma Tutorial on Auto Layout", dueDate: "Due May 26", avatar: "AW", link: "Front End Development" },
        { name: "Andrea Watson", task: "Watch Figma Tutorial on Auto Layout", dueDate: "Due May 26", avatar: "AW", link: "Front End Development" }
      ]
    },
    {
