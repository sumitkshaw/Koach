    ...
    return (
      <div className="bg-white py-8 ">
        <div className="max-w-9xl mx-auto  px-4">
          <div className="font-bold text-[22px] text-black-800 text-center mb-12  justify-center item-center ">
            A{' '}
            <a 
            ...
            report states that employees spend 1.8 hours every day—9.3 hours per week, on an average searching.
          </div>
          ...
          <div className='w-[600px] h-[80px] pt-10 overflow-hidden relative'>
          <div className="flex min-w-max  gap-12 animate-marquee">
            {/* eBay Logo */}
            {[...companies,...companies].map((company)=>(
              <div key={company.id} className='object-cover' style={{ height: company.h, width: company.w, marginTop:company.margintop }}>
                <img src={company.image} alt={company.alt} className='w-full h-full'/>
              </div>
            ))}
          </div>
          </div>
