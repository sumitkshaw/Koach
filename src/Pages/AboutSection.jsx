  ...
  return (
    <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-20">
      ...
      <div className="flex flex-col lg:flex-row items-start gap-10">
        ...
        <div className="relative lg:w-1/2 w-full mt-6 lg:mt-0 lg:min-h-[500px]">
          <img
            src={Shade}
      ...
      <div className="flex flex-col lg:flex-row items-start gap-10">
        ...
        <div className="relative lg:w-1/2 w-full mt-6 lg:mt-0 flex justify-center lg:min-h-[500px]">
          <img
            src={Shade}
            className="object-cover w-full max-h-[400px] rounded-xl"
          />
