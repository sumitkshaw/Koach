  ...
  return (
    <div className="w-full bg-[#050A30] py-14 mt-20">
      <div className="max-w-[1200px] mx-auto mb-20 px-4">
          ...
          <div className="flex gap-5 mt-5 md:mt-0">
            {socialLinks.map((link) => (
              <a
                key={link.name}
                href={link.href}
                className="hover:text-[#F5E649] text-white transition-colors duration-200"
        ...
        <hr className="border-[#F5E649] mt-6 border" />
        <div className="flex flex-wrap justify-between text-white text-left gap-10 mt-14">
          <div>
