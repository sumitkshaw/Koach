...
export default function SignUpPage() {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      {/* Left Panel - Form */}
      <div className="flex-1 bg-white flex flex-col justify-center px-8 py-12 lg:px-16 max-w-md lg:max-w-lg xl:max-w-xl">
        {/* Back Button */}
        <button
          onClick={() => navigate("/")}
      ...
      {/* Right Panel - Image */}
      <div className="flex-1 hidden lg:block relative overflow-hidden rounded-l-3xl shadow-2xl">
        {/* Background Image */}
        <img
          src={SignupImage}
          alt="Sign Up Visual"
