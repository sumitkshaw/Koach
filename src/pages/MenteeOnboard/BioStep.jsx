      ...
      <div className="flex flex-col justify-center items-center w-full lg:w-1/2 bg-gradient-to-br from-blue-50 via-white to-indigo-50 lg:bg-white px-4 sm:px-6 lg:px-12 py-8 sm:py-12">
        <div className="w-full max-w-xl">
          ...
          <div className="flex flex-col items-center justify-center mb-6 sm:mb-8 lg:mb-8">
            ...
            <h1 className="text-3xl sm:text-3xl lg:text-3xl font-bold bg-gradient-to-r from-[#1E4AB8] to-[#4A90E2] bg-clip-text text-transparent mb-2 text-center relative z-10">
              Your Bio
            </h1>
            <p className="text-sm sm:text-base text-gray-600 lg:text-[#1E4AB8] text-center relative z-10">
          ...
          <div className="flex justify-center mt-8 sm:mt-10 w-full relative z-10">
            <div className="flex gap-3 sm:gap-8 w-full justify-center">
              <button
                ...
                className="lg:w-40 w-full sm:w-32 py-3 sm:py-3 text-sm sm:text-base border-2 border-[#FFD93B] text-[#1E4AB8] rounded-xl hover:bg-[#FFD93B] transition-all duration-200 font-semibold shadow-md lg:shadow-none hover:shadow-lg active:scale-95"
              >
                Back
              </button>
              <button
                onClick={handleNext}
                className="lg:w-40 w-full sm:w-32 py-3 sm:py-3 text-sm sm:text-base bg-gradient-to-r from-[#FFD93B] to-[#FFE066] text-[#1E4AB8] rounded-xl hover:opacity-90 transition-all duration-200 font-semibold shadow-md lg:shadow-none hover:shadow-lg active:scale-95"
              >
                Next
              </button>
            </div>
