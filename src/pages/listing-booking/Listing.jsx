...
function Listing() {
  ...
  const filters = [
    { label: '2+ years', active: true },
    { label: 'English', active: true },
    { label: 'Information Technology', active: true }
  ];

  const handleCardClick = (mentor) => {
    const firstName = mentor.name.split(' ')[0].toLowerCase();
    navigate(`/listing/${firstName}`);
  };

  return (
    <div className="w-full bg-[#ECF0F6] min-h-screen">
      {/* Header Section */}
      <section className="bg-white px-6 md:px-20 lg:px-40 pt-24 pb-8 md:pt-32 md:pb-12">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#2D488F] mb-2">
            Mentors
          </h1>
